            ...
            <FlipCard
                ...
                frontContent={
                    <div className='h-full'>
                        ...
                        <h3 className='pt-2 font-[1000] tracking-widest text-right'>{siteConfig('HEO_SOCIAL_CARD_TITLE_2', null, CONFIG)}</h3>
              ...
              <img src="https://s1.locimg.com/2024/08/28/08e9dd44d99e9.png" alt="TG" className="w-16 h-16 object-cover rounded-full border-4 border-white mr-4" />
